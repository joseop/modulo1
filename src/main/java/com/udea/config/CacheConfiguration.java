...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.udea.domain.UnidadAcademica.class.getName());
            createCache(cm, com.udea.domain.UnidadAcademica.class.getName() + ".subunidadAcademicas");
            createCache(cm, com.udea.domain.SubunidadAcademica.class.getName());
            createCache(cm, com.udea.domain.SubunidadAcademica.class.getName() + ".programaAcademicos");
