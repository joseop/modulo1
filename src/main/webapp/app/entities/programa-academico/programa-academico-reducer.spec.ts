...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './programa-academico.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMAACADEMICO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRAMAACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRAMAACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRAMAACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMAACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRAMAACADEMICO actions', async () => {
      const expectedActions = [
        {
