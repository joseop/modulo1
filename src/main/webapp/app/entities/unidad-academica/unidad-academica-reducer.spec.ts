...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIDADACADEMICA_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIDADACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIDADACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIDADACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIDADACADEMICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIDADACADEMICA actions', async () => {
      const expectedActions = [
        {
